...
cars_train_path = "/content/drive/MyDrive/DL/Lab07/cars/train"
cars_test_path = "/content/drive/MyDrive/DL/Lab07/cars/test"
writer = SummaryWriter("/content/drive/MyDrive/DL/Lab07/runs/CARS_WRITING")
...
%tensorboard --logdir '/content/drive/MyDrive/DL/Lab07/runs/CARS_WRITING'